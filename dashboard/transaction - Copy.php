			...
			submitSuccess: function ($form, event) {
			  ...
			  $.ajax({
				...
				{ 
					...
					//alert(received_data.trans_percentage);
        ...
        <!-- end upper main stats -->
          ...
          <div id="pad-wrapper">
                  ...
                  <h3>Transaction <span id="trans_type">: trader (B2B)</span></h3>
                    ...
                    <h4>* ONLY THE SELLER CAN INPUT DATA HERE *</h4>
            			<div class="col-xs-12 col-md-6"> 
                    
                    <form class="form-horizontal"  id="add_transaction" name="add_transaction" action="php/add_transaction.php" method="post">
                     
                     <div class="field-box">
                     <label><!--Select Type: <a class="hover_span">help
                            <div class="hover_content">
                                <p class="notice_small" >Please select which type of customer you wish to create a transaction for. If it's B2B you will notice the system has compiled a dynamic list of traders you do business with. If it's B2C, please enter the customer's BARTER card number in the box provided. Otherwise if the sale is for a non barter memeber (such as local or non local) please attribute a name towards this sale. </p>
                          </div></a>-->
                          </label>
                       
                        <label  for="cust_type">Transaction Type: </label>
                            <select id="cust_type" name="dob" class="form-control">
                           ...
                           <!--<button id="customer_icon" type="button" data-toggle="button">
                            <img id="barter_trader_customer" src="../images/barter_trader.png" width="80" />
                            <img id="barter_customer" src="../images/barter_customer.png" width="80" hidden="true"/>
                            <img id="local_customer" src="../images/local_non_barter.png" width="80" hidden="true" />
                            <img id="external_customer" src="../images/non_local.png" width="80" hidden="true" />
                            </button>-->
                      ...
                      <div class="field-box" id="non_barter_input" hidden="true">
                   
                    <div class="input-group col-lg-8">
                     <label id="consumer_name">Name / Email:</label>
                        <input id="customer_id1" name="customer_id1"  type="text" placeholder="" class="form-control input-large">
                    </div>
                   
                </div>
         	
                 <div class="field-box" id="points">
