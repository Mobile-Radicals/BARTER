    ...
    <div class="content">
          ...
          <div id="pad-wrapper">
            <h1>Updates/Notifications</h1>
                ...
                echo "<ul style='list-style:none; magin:0px; padding:0px;'>";
                foreach ($data as $item)
                {
                    echo "<li style='background:#f2f2f2; padding:10px; margin:0px;'><h4>".$item[0]."</h4><p style='font-style:italic; padding:0px; margin:0px;'>".$item[1]."</p><p style='font-size:10px; padding:0px; margin:0px;'>".convert_to_date($item[2])."</p></li>";
                }
                echo "</ul>";
                ?>
          </div>
